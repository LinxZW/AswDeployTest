...
def ThreadView(request, thread_id):
    ...
    return render(request, 'view_thread.html', {'thread': thread, 'comments': comments, 'form': form, 'form_edit': get_edit_comment_form(request, edit_comment_id), 'now': now, 'reply_to_comment_id': reply_to_comment_id, 'level': 0})
